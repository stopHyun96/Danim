...
<html>
	...
	<c:if test="${userEmail eq null}">
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-12">
					<form action="/board/reviewUpload.do" method="post" enctype="multipart/form-data">
						...
						<div class="form-group my-3">
							<label>내용</label>
							<textarea id="content" name="content" rows="10" class="form-control" style="resize: none;" required></textarea>
						</div>
